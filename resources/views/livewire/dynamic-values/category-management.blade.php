        ...
        <div class="card w-full flex flex-col gap-5">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-0.5">
                        Manage asset categories and icons
                    </p>
                </div>
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-xl p-4 flex gap-3 items-center">
                <div
                    ...
                    title="Select Icon"
                >
                    <img src="{{ asset('img/' . $newIcon . '.png') }}" class="w-6 h-6 object-contain" alt="">
                </div>
                            ...
                            <div class="flex flex-col w-full gap-3">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex gap-2">
                                        <button
                                            wire:click="saveEdit"
                                            class="px-3 py-1 bg-teal-500 hover:bg-teal-600 text-white text-xs font-semibold rounded-lg transition"
                                        >
                                            Save
                                        </button>
                                ...
                                <div class="grid grid-cols-8 gap-2">
                                    @foreach($icons as $icon)
                                        ...
                                        >
                                            <img src="{{ asset('img/' . $icon . '.png') }}" class="w-5 h-5 mx-auto object-contain" alt="">
                                        </div>
                                    @endforeach
                                </div>
                        ...
                        @else
                            ...
                            <div class="flex items-center gap-3 flex-1">
                                <div class="w-8 h-8 flex items-center justify-center bg-gray-100 rounded-lg flex-shrink-0">
                                    <img src="{{ asset('img/' . $cat->icon . '.png') }}" class="w-5 h-5 object-contain" alt="">
                                </div>
                ...
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-6 gap-3">
                        @foreach($icons as $icon)
                            ...
                            >
                                <img src="{{ asset('img/' . $icon . '.png') }}" class="w-8 h-8 mx-auto object-contain" alt="">
                            </div>
                        @endforeach
                    </div>
