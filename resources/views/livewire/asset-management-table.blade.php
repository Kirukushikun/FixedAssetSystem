<div class="card content flex-1 flex flex-col" x-data="{
     ...
     >
          <div class="relative bg-white p-10 rounded-lg shadow-lg">
               ...
               <!-- Category List - OPTIMIZED: Use Alpine.js instead of Livewire for instant toggling -->
               ...
               <div class="flex flex-col gap-5 w-[25rem]" x-show="modalTemplate === 'audit-log-filter'">
