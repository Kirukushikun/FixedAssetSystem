...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Update existing records to change status from 'Pending VP Approval' to 'Pending Division Head Approval'
        DB::table('disposal_requests')
    ...
    public function down(): void
    {
        ...
        DB::table('disposal_requests')
            ...
            ->update(['status' => 'Pending VP Approval']);
    }
};
